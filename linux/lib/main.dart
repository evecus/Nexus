...
void main() async {
  ...
  // AppDataDir.root（Linux 端是 XDG 数据目录 ~/.local/share/nexus，
  ...
  await StorageService.init(boxName: 'nexus_linux');
  ...
  runApp(const NexusLinuxApp());
}

class NexusLinuxApp extends StatelessWidget {
  const NexusLinuxApp({super.key});
