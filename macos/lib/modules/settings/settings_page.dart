...
class SettingsPage extends StatelessWidget {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                // 1. 视频播放后端（本地视频）
                Obx(() {
                  // macOS 端只提供 MPV / VLC 两个选项。onInit 已把存储里
                ...
                FutureBuilder<PackageInfo>(
                  ...
                  builder: (_, snap) => ListTile(
                    title: const Text('Nexus for macOS'),
  ...
  String _backendLabel(PlayerBackendChoice c, {required bool isIptv}) {
    switch (c) {
      ...
      // auto/exo 在 macOS 端不会出现（onInit 已迁移、UI 不展示），
